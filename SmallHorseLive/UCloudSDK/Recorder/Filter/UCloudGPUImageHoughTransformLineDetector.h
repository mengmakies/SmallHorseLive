...
@interface UCloudGPUImageHoughTransformLineDetector : UCloudGPUImageFilterGroup
{
    UCloudGPUImageOutput<UCloudGPUImageInput> *thresholdEdgeDetectionFilter;
    
//    GPUImageThresholdEdgeDetectionFilter *thresholdEdgeDetectionFilter;
    UCloudGPUImageParallelCoordinateLineTransformFilter *parallelCoordinateLineTransformFilter;
