 ...
 */
@protocol UCloudGPUImageMovieDelegate <NSObject>
 ...
 */
@interface UCloudGPUImageMovie : UCloudGPUImageOutput
 ...
 */
@property (readwrite, nonatomic, assign) id <UCloudGPUImageMovieDelegate>delegate;
...
- (void)enableSynchronizedEncodingUsingMovieWriter:(UCloudGPUImageMovieWriter *)movieWriter;
