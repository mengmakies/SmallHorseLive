...
@class UCloudGPUImageSaturationFilter;
@class UCloudGPUImageGaussianBlurFilter;
@class UCloudGPUImageLuminanceRangeFilter;

@interface UCloudGPUImageiOSBlurFilter : UCloudGPUImageFilterGroup
{
    UCloudGPUImageSaturationFilter *saturationFilter;
    UCloudGPUImageGaussianBlurFilter *blurFilter;
    UCloudGPUImageLuminanceRangeFilter *luminanceRangeFilter;
}
