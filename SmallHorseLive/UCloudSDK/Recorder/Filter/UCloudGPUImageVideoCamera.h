...
void setUCloudColorConversion601( GLfloat conversionMatrix[9] );
void setUCloudColorConversion601FullRange( GLfloat conversionMatrix[9] );
void setUCloudColorConversion709( GLfloat conversionMatrix[9] );


//Delegate Protocal for Face Detection.
@protocol UCloudGPUImageVideoCameraDelegate <NSObject>
...
*/
@interface UCloudGPUImageVideoCamera : UCloudGPUImageOutput <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
{
...
@property(nonatomic, assign) id<UCloudGPUImageVideoCameraDelegate> delegate;
