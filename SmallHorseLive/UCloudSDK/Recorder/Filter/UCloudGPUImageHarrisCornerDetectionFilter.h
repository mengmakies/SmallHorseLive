...
@class UCloudGPUImageXYDerivativeFilter;
@class UCloudGPUImageGrayscaleFilter;
@class UCloudGPUImageGaussianBlurFilter;
@class UCloudGPUImageThresholdedNonMaximumSuppressionFilter;
@class UCloudGPUImageColorPackingFilter;
 ...
 */
@interface UCloudGPUImageHarrisCornerDetectionFilter : UCloudGPUImageFilterGroup
{
    UCloudGPUImageXYDerivativeFilter *derivativeFilter;
    UCloudGPUImageGaussianBlurFilter *blurFilter;
    UCloudGPUImageFilter *harrisCornerDetectionFilter;
    UCloudGPUImageThresholdedNonMaximumSuppressionFilter *nonMaximumSuppressionFilter;
    UCloudGPUImageColorPackingFilter *colorPackingFilter;
