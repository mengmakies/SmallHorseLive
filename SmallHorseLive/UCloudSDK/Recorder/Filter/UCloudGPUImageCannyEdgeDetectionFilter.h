...
@class UCloudGPUImageSingleComponentGaussianBlurFilter;
@class UCloudGPUImageDirectionalSobelEdgeDetectionFilter;
@class UCloudGPUImageDirectionalNonMaximumSuppressionFilter;
@class UCloudGPUImageWeakPixelInclusionFilter;
 ...
 */
@interface UCloudGPUImageCannyEdgeDetectionFilter : UCloudGPUImageFilterGroup
{
    UCloudGPUImageGrayscaleFilter *luminanceFilter;
    UCloudGPUImageSingleComponentGaussianBlurFilter *blurFilter;
    UCloudGPUImageDirectionalSobelEdgeDetectionFilter *edgeDetectionFilter;
    UCloudGPUImageDirectionalNonMaximumSuppressionFilter *nonMaximumSuppressionFilter;
    UCloudGPUImageWeakPixelInclusionFilter *weakPixelInclusionFilter;
}
