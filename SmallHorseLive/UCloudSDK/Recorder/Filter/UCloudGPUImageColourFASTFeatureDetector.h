...
@class UCloudGPUImageColourFASTSamplingOperation;
@class UCloudGPUImageBoxBlurFilter;

@interface UCloudGPUImageColourFASTFeatureDetector : UCloudGPUImageFilterGroup
{
    UCloudGPUImageBoxBlurFilter *blurFilter;
    UCloudGPUImageColourFASTSamplingOperation *colourFASTSamplingOperation;
}
