...
@interface UCloudGPUImageMotionDetector : UCloudGPUImageFilterGroup
{
    UCloudGPUImageLowPassFilter *lowPassFilter;
    UCloudGPUImageTwoInputFilter *frameComparisonFilter;
    UCloudGPUImageAverageColor *averageColor;
}
