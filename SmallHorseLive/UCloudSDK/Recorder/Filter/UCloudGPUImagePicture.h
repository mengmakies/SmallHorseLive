...
@interface UCloudGPUImagePicture : UCloudGPUImageOutput
{
...
- (void)processImageUpToFilter:(UCloudGPUImageOutput<UCloudGPUImageInput> *)finalFilterInChain withCompletionHandler:(void (^)(UIImage *processedImage))block;
